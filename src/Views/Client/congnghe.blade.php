                        ...
                        <div class="utf_post_block_style post-list clearfix">
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <div class="utf_post_thumb thumb-float-style">
                                        <a href="#">
                                            <img class="img-fluid" src="assets/client/assets/images/news/tech/game2.jpg" alt="" />
                                        </a>
                                ...
                                <div class="col-lg-7 col-md-6">
                                    <div class="utf_post_content">
                                        <h2 class="utf_post_title title-large">
                                            <a href="#">Lindie game plonks players in front of huge
                                                starship command center</a>
                                        </h2>
                                        <div class="utf_post_meta">
                                            <span class="utf_post_author"><i class="fa fa-user"></i>
                                                <a href="#">John Wick</a></span>
                        ...
                        <div class="utf_post_block_style post-list clearfix">
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <div class="utf_post_thumb thumb-float-style">
                                        <a href="#">
                                            <img class="img-fluid" src="assets/client/assets/images/news/tech/robot3.jpg" alt="" />
                                        </a>
                                        <a class="utf_post_cat" href="#">Traveling</a>
                                    </div>
                                </div>
                        ...
                        <div class="utf_post_block_style post-list clearfix">
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <div class="utf_post_thumb thumb-float-style">
                                        <a href="#">
                                            <img class="img-fluid" src="assets/client/assets/images/news/tech/gadget2.jpg" alt="" />
                                        </a>
                                ...
                                <div class="col-lg-7 col-md-6">
                                    <div class="utf_post_content">
                                        <h2 class="utf_post_title title-large">
                                            <a href="#">Samsung Gear S3 review: A whimper, when
                                                smartwatches need a bang</a>
                                        </h2>
                                        <div class="utf_post_meta">
                                            <span class="utf_post_author"><i class="fa fa-user"></i>
                                                <a href="#">John Wick</a></span>
                        ...
                        <div class="utf_post_block_style post-list clearfix">
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <div class="utf_post_thumb thumb-float-style">
                                        <a href="#">
                                            <img class="img-fluid" src="assets/client/assets/images/news/tech/game1.jpg" alt="" />
                                        </a>
                                        <a class="utf_post_cat" href="#">Games</a>
                                    </div>
                                </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="sidebar utf_sidebar_right">
                                ...
                                <ul class="utf_list_post">
                                    <li class="clearfix">
                                        <div class="utf_post_block_style post-float clearfix">
                                            <div class="utf_post_thumb">
                                                <a href="#">
                                                    <img class="img-fluid" src="assets/client/assets/images/news/tech/gadget3.jpg"
                                                        alt="" />
                                                </a>
                                                <a class="utf_post_cat" href="#">Lifestyle</a>
                                            </div>
                                    ...
                                    <li class="clearfix">
                                        <div class="utf_post_block_style post-float clearfix">
                                            <div class="utf_post_thumb">
                                                <a href="#">
                                                    <img class="img-fluid" src="assets/client/assets/images/news/lifestyle/travel5.jpg"
                                                        alt="" />
                                                </a>
                                    ...
                                    <li class="clearfix">
                                        <div class="utf_post_block_style post-float clearfix">
                                            <div class="utf_post_thumb">
                                                <a href="#">
                                                    <img class="img-fluid" src="assets/client/assets/images/news/lifestyle/food1.jpg"
                                                        alt="" />
                                                </a>
                        ...
                        <div class="widget text-center">
                            <img class="banner img-fluid" src="assets/client/assets/images/banner-ads/ad-sidebar.png" alt="" />
                        </div>
