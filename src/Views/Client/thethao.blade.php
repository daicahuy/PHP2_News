                        ...
                        <div class="utf_post_block_style post-list clearfix">
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <div class="utf_post_thumb thumb-float-style">
                                        <a href="#">
                                            <img class="img-fluid" src="assets/client/assets/images/news/tech/game2.jpg"
                                                alt="" />
                                        </a>
                        ...
                        <div class="utf_post_block_style post-list clearfix">
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <div class="utf_post_thumb thumb-float-style">
                                        <a href="#">
                                            <img class="img-fluid" src="assets/client/assets/images/news/tech/robot3.jpg"
                                                alt="" />
                                        </a>
                                        <a class="utf_post_cat" href="#">Traveling</a>
                                    </div>
                        ...
                        <div class="utf_post_block_style post-list clearfix">
                            <div class="row">
                                <div class="col-lg-5 col-md-6">
                                    <div class="utf_post_thumb thumb-float-style">
                                        <a href="#">
                                            <img class="img-fluid" src="assets/client/assets/images/news/tech/gadget2.jpg"
                                                alt="" />
                                        </a>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="sidebar utf_sidebar_right">
                                    ...
                                    <li class="clearfix">
                                        <div class="utf_post_block_style post-float clearfix">
                                            <div class="utf_post_thumb">
                                                <a href="#">
                                                    <img class="img-fluid"
                                                        src="assets/client/assets/images/news/lifestyle/food1.jpg"
                                                        alt="" />
                                                </a>
                        ...
                        <div class="widget text-center">
                            <img class="banner img-fluid" src="assets/client/assets/images/banner-ads/ad-sidebar.png"
                                alt="" />
                        </div>
