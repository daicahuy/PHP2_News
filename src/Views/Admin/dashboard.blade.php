...
@section('css')
    <!--Morris Chart CSS -->
    <link rel="stylesheet" href="/assets/admin/assets/plugins/morris/morris.css" />
@endsection
        ...
        <div class="col-xl-4">
            ...
            <div class="card-body">
                ...
                <li class="activity-item">
                    ...
                    >Responded to need “Volunteer Activities”</span
                    >
                ...
                <li class="activity-item">
                    ...
                    <div>
                    <a href="#" class="activity-item-img"
                        ><img
                        src="assets/admin/assets/images/small/img-1.jpg"
                        alt=""
                        class="rounded mb-2" /></a
                    ><a href="#" class="activity-item-img"
                        ><img
                        src="assets/admin/assets/images/small/img-2.jpg"
                        alt=""
                        class="rounded mb-2"
                    /></a>
                    </div>
                ...
                <li class="activity-item">
                    ...
                    <a href="#" class="text-muted"
                        ...
                        ></i>
                        <p class="mt-2 mb-0">background.psd</p></a
                    >
                    </div>
                </li>
                </ul>
...
@section('js')
    ...
    <!-- dashboard -->
    <script src="/assets/admin/assets/pages/dashboard.js"></script>
@endsection